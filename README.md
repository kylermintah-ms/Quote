...
> **Just a Note:** As we can see in the screenshot in step 7. b), GitHub already detects that our branch has had recent pushes and prompts us to open a Pull Request. 
> Hence we could have also selected `Compare & pull request` as an alternative which would have skipped steps b through d.
